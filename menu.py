...
def company_creation_menu(player, screen):
    ...
    menu.add.range_slider('Investment Amount: ', default=1000,
                          range_values=(1000, player.personal_gold),
                          increment=500, onchange=set_investment)
    menu.add.selector('Use Outside Investors: ', [('Yes', True), ('No', False)],
                      default=1, onchange=set_outside_investors)
