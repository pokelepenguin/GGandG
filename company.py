class Company:
    def __init__(self, company_id, founder, initial_investment, public=False):
        ...
        # Assign shares to founder
        if public:
            # Founder must invest at least 25%
            founder_shares = self.shares_outstanding * 0.25
